            ...
            <section className="lg:px-80 mt-6">
                <div className="join join-vertical w-full">
                    <div className="collapse collapse-arrow join-item border-base-300 border">
                        ...
                        <div className="collapse-content">
                            <p>&#34Saya merasa beruntung bisa kuliah di jurusan Akuntansi TSM. Kurikulumnya sangat mendalam dan komprehensif, mencakup berbagai aspek akuntansi seperti perpajakan, auditing, dan manajemen keuangan. Dosen-dosennya profesional dan sangat membantu dalam menjelaskan konsep yang sulit dengan cara yang mudah dipahami. Setelah mengikuti beberapa program magang yang difasilitasi oleh kampus, saya merasa lebih siap untuk menghadapi dunia kerja dan percaya diri dengan kemampuan saya.&#34</p>
                        </div>
                    </div>
                    <div className="collapse collapse-arrow join-item border-base-300 border">
                        <input type="radio" name="my-accordion-4" />
